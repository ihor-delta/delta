...
- to defend victim(s) becomes the first priority task of defender(s) if there is armored/unarmored or psychological agression is commiting/commited/plan to be commited in future/planed to be commited in future against, some representative(s) or social institution(s) which automatically become(s) victim(s)
